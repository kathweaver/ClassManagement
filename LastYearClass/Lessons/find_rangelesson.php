...
if ($user_level==4){
	echo "<head>";
	echo "</head>";
	echo ('<form name="form1" action="rangelessons.php" method=POST>');
	...
	echo ('<p>');
	echo ('<br>');
	echo ('Beginning Day: <input name="beginday" type="text" id="day"  value=""');
	echo ('<br>');
	echo ('End Day: <input name="endday" type="text" id="day"  value=""');
	echo ('<br>');
