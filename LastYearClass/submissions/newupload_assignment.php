...
function list_assignments()
{
	...
	$q1 = "SELECT Assignment, Name FROM Lessons, Assignments WHERE Lessons.Assignment = Assignments.Index  And Subject = '$class' AND SixWeeks='$SixWeeks' AND TurnIn='1' GROUP BY Assignments.Index ORDER BY Day";
