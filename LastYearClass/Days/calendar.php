...
echo "<div id='calendar'>".
	 "<table border=\"1\" cellpadding=\"2\" cellspacing=\"0\" width=\"300\" class=\"calendar\">\n". 
     "<tr>\n". 
     "<td colspan=\"7\">\n". 
     "<table align=\"center\">\n". 
     "<tr>\n". 
...
echo '<div id="list">';
if ($Exists)
	echo "Current Date: $startDate   Six Weeks: $SixWeeks Day: $AssignmentDay";
else
	echo '<a href="http://www.kweaver.net/class/Days/daydetail.php?mode=add">Add Day</a>';
