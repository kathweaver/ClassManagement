   ...
   <TR>
      ...
      <TD> 
        ...
        <CENTER>
          ...
          <P><strong>A Web Quest for 9-12th Grade Webmastering</strong></P>
        ...
        <p>In determining what kind of processor you want, and peripherals, start 
          with the following web sites.</p>
...
<li>A guide to building your own computer<br>
        ...
        <ul>
          ...
          <li><a href="http://www.pcworld.com/reviews/article/0,aid,52524,00.asp">CD-RW 
            Information</a></li>
          <li><a href="http://www.pcworld.com/reviews/article/0,aid,117420,00.asp">DVD 
            Information</a></li>
        ...
        <P>There are several reasons I created this project. </P>
        ...
        <p>I would like to thank Charmaine Bentley, Roosevelt High School, Dallas, 
          ISD for suggesting this project in our district curriculum, I've taken 
          it a bit further.</P>
