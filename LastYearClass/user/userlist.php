...
<?php 
    function loadlist($s) { 
        ...
        $q1 = "SELECT * FROM users ORDER BY $sortby"; 
           $rslt1 = mysql_query($q1) or die("Query failed"); 
     
        echo "<table><tr><th colspan=4>Users</th></tr>"; 
        echo "<tr><th><a href=".$_SERVER['SCRIPT_NAME'].">Level</a></th><th><a href=".$_SERVER['SCRIPT_NAME']."?sort=username>Username</a></th><th><a href=".$_SERVER['SCRIPT_NAME']."?sort=firstname>First Name</a><th><a href=".$_SERVER['SCRIPT_NAME']."?sort=lastname>Last Name</a></th><TH>Student Id</TH><th><a href=".$_SERVER['SCRIPT_NAME']."?sort=class>Class</a></th><th><a href=".$_SERVER['SCRIPT_NAME']."?sort=period>Period</a></th><th>Email</th><th>Activated</th><TH></TH><TH></TH></tr>\n"; 
           while ($row1 = mysql_fetch_array($rslt1, MYSQL_ASSOC)) { 
			...
			echo "\t\t<td><a href=$dtlUrl>".$row1['StudentId']."</a></td>";
